...
public class Admin_Appointment {
    ...
    private Admin_Employee receptionist;

    // Constructors
    public Admin_Appointment() {}

    public Admin_Appointment(Integer appointmentId, LocalDateTime appointmentTime, String status, Integer receptionistEid) {
    ...
    public Admin_Employee getReceptionist() { return receptionist; }
    public void setReceptionist(Admin_Employee receptionist) { this.receptionist = receptionist; }
