...
public class Admin_Employee {
    ...
    private List<Admin_EmployeePhone> phones;
    ...
    public List<Admin_EmployeePhone> getPhones() { return phones; }
    public void setPhones(List<Admin_EmployeePhone> phones) { this.phones = phones; }
...
class Admin_EmployeePhone {
    @EmbeddedId
    private Admin_EmployeePhoneId id;
    ...
    // Getters and setters
    public Admin_EmployeePhoneId getId() { return id; }
    public void setId(Admin_EmployeePhoneId id) { this.id = id; }
...
@Embeddable
class Admin_EmployeePhoneId implements Serializable {
    ...
    // Default constructor
    public Admin_EmployeePhoneId() {}

    // Parameterized constructor
    public Admin_EmployeePhoneId(Integer eid, String phoneNumber) {
        this.eid = eid;
    ...
    public boolean equals(Object o) {
        ...
        Admin_EmployeePhoneId that = (Admin_EmployeePhoneId) o;
