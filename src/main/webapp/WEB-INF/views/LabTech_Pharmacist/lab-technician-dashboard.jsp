            ...
            <div class="d-flex align-items-center">
                <div class="dropdown">
                    <button class="btn btn-outline-primary dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-inline">${not empty employeeFirstName ? employeeFirstName : 'Lab Technician'}</span>
                    </button>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="welcome-card">
                    <h1 class="display-6 fw-bold text-dark-blue mb-2">🔬 Welcome Back, ${not empty employeeFirstName ? employeeFirstName : 'Lab Technician'}!</h1>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="${not empty employeeId ? employeeId : 'N/A'}" readonly>
                            <small class="text-muted">Cannot be modified</small>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Position</label>
                            <input type="text" class="form-control" value="Lab Technician" readonly>
                            <small class="text-muted">Cannot be modified</small>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">First Name</label>
                            <input type="text" class="form-control" name="firstName" value="${not empty employeeFirstName ? employeeFirstName : ''}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Last Name</label>
                            <input type="text" class="form-control" name="lastName" value="${not empty employeeLastName ? employeeLastName : ''}" required>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-bold">Email</label>
                            <input type="email" class="form-control" name="email" value="${not empty employeeEmail ? employeeEmail : ''}">
                        </div>
                        <div class="col-md-6">
