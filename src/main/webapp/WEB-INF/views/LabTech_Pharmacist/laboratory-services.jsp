...
<head>
    ...
    <link rel="stylesheet" href="/css/laboratory-services.css">
</head>
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="laboratory-services">Laboratory Services</a></li>
        ...
        <div class="container">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center text-center text-md-start">
                ...
                <nav class="nav justify-content-center mb-3 mb-md-0">
                    ...
                    <a class="nav-link text-secondary" href="pharmacy-home">Pharmacy</a>
                    <a class="nav-link text-secondary" href="laboratory-services">Laboratory</a>
                </nav>
