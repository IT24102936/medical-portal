                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        <button class="btn btn-outline-primary dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-inline">${not empty employeeFirstName ? employeeFirstName : 'Pharmacist'}</span>
                        </button>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="welcome-card">
                        <h1 class="display-6 fw-bold text-dark-blue mb-2">🏥 Welcome Back, ${not empty employeeFirstName ? employeeFirstName : 'Pharmacist'}!</h1>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="Pharmacist" readonly>
                                <small class="text-muted">Cannot be modified</small>
                            </div>
