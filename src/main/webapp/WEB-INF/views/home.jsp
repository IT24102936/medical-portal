        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary py-1 px-3 px-lg-5">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-flex flex-column flex-lg-row mt-3 mt-lg-0 gap-2">
                        <a href="/login" class="btn btn-outline-primary fw-bold px-4 py-2">Log In</a>
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary fw-bold px-4 py-2 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                Sign Up
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/register">Employee Registration</a></li>
                                <li><a class="dropdown-item" href="/register-patient">Patient Registration</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <main>
        <section class="hero-section d-flex align-items-center justify-content-center py-5">
            <div class="container text-center text-white px-3">
                ...
                <div class="mt-5 d-flex justify-content-center gap-3 flex-wrap">
                    <a href="#" class="btn btn-primary fw-bold fs-5 px-5 py-3 rounded-3">Book an Appointment</a>
                    <a href="#" class="btn btn-light fw-bold fs-5 px-5 py-3 rounded-3 text-primary">View Services</a>
                </div>
            </div>
        </section>
        ...
        <section class="py-5" style="background-color: #f8f9fa;">
            <div class="container my-5 text-center px-3">
                ...
                <div class="mt-4">
                    <a href="/register" class="btn btn-primary fw-bold fs-5 px-5 py-3 rounded-3">Get Started Now</a>
                </div>
            </div>
        </section>
    </main>
