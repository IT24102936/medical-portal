...
<head>
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            body { overflow: auto; }
            .branding-section { height: auto; min-height: 200px; }
            .branding-content h1 { font-size: 2.8rem; }
            .form-section { height: auto; padding: 40px 25px; }
            ...
            <div class="login-wrapper">
                ...
                <form action="/login" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="loginUser" name="username" placeholder="Enter your username or email" required>
                    </div>
                    <div class="mb-3">
